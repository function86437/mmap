# Exampl of embedding CEF Python browser using wxPython library.
...
def main():
    ...
    settings= {
        "cache_path": "/Users/linyanfu/cache/",
        "debug": True,
...
class MainFrame(wx.Frame):
    ...
    def embed_browser(self):
        ...
        self.browser = cef.CreateBrowserSync(window_info,
                url="http://140.116.82.225:8000/login")
...
class LoadHandler(object):
    def OnLoadingStateChange(self, browser, is_loading, **_):
        if not is_loading:
            print("in LoadHandler")

class RequestHandler(object):
    def OnBeforBrowse(self, browser, frame, request, is_redirect):
        print("in Request")    
        request.SetPostData(
                {'username':'user1',
                    'password':'useruser',
...
class External(object):
    ...
    def callbacks(self, js_callback):
        print("x")
